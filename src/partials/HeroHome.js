      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">박강용을 고용하세요 <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400"><br/>그는 환상적인 신입개발자</span></h1>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <a className="btn text-white bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0">이력서 열람하기</a>
                </div>
                <div>
                  <a className="btn text-white bg-gray-900 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0">지금당장 채용하기</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              ...
              <button className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group p-4 shadow-lg" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVideoModalOpen(true); }} aria-controls="modal">
                ...
                <span className="ml-3">자기소개 동영상 보기(1 min)</span>
              </button>
            </div>
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              ...
              <iframe title="vimeo-player" src="https://player.vimeo.com/video/616548310?h=2bef537170" width="640" height="360" frameborder="0" allowfullscreen></iframe>
              </div>
            </Modal>
